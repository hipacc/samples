...
main_cpu.cc: src\main.cpp
  "%HIPACC_PATH%\bin\hipacc.exe" -std=c++11 -emit-cpu %HIPACC_OPTS% -o "$@" -I "%HIPACC_PATH%/include/dsl" -I "%HIPACC_PATH%/include/c++/v1" -I "%HIPACC_PATH%/include/clang" -I ../../common "$**"

main_cpu.exe: main_cpu.cc
  cl.exe /Ox /W0 /EHsc $** /I "%HIPACC_PATH%\include" /I ..\..\common $(CXX_FLAGS_OPENCV)

main_cuda.cc: src\main.cpp
  "%HIPACC_PATH%\bin\hipacc.exe" -std=c++11 -emit-cuda %HIPACC_OPTS% -o "$@" -I "%HIPACC_PATH%/include/dsl" -I "%HIPACC_PATH%/include/c++/v1" -I "%HIPACC_PATH%/include/clang" -I ../../common "$**"
